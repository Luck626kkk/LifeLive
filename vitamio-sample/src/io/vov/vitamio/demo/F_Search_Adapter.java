...
public class F_Search_Adapter extends ArrayAdapter<Actors> {
    ...
    public F_Search_Adapter(Context context, int resource, ArrayList<Actors> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
           ...
           // holder.tvTitle = (TextView) v.findViewById(R.id.Title);
            holder.tvClassName = (TextView) v.findViewById(R.id.txtClasss);
        ...
        holder.tvClassName.setText("分類: "+actorList.get(position).getClasss());
